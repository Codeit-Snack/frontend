  ...
  return (
    <button
      ...
      className={`
        ...
        transition-transform hover:translate-y-[-2px] hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[var(--secondary-illustration-06)]"
        `}
      aria-label="상품 등록"
    >

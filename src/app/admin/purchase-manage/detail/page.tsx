            ...
            <section className="order-2 space-y-4 lg:order-1">
              ...
              <div className="mt-6 flex gap-3">
                <Button
                  type="button"
                  variant="outlined"
                  className="!h-14 !min-w-0 !flex-1 !rounded-[16px] !border-0 !bg-[var(--gray-gray-100,#F2F2F2)] text-center text_xl_semibold !text-[var(--gray-gray-500,#999999)] cursor-pointer xl:!h-[72px]"
                >
                  요청 반려
                </Button>
                <Button
